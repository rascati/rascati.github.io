...
const Letterforms = () => (
  <Layout border>
    ...
    <Wrapper>
      <div>
        <p>This project from Northeastern's Typography 1 course is to explore letterform geometry.</p>
        <p>Each form is made of two different glyphs from the same typeface, with parts of the glyph removed to create a new form.</p>  
        <p>These are great starting points for logo brainstorming. There's potential for some
        cool marks especially with more work messing around with stroke weight and pathing to add a bit more playfullness and movement to the shape.</p>  
      </div>
